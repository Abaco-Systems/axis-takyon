...
#define XFER_COMMAND       999888
#define BARRIER_INIT_STEP1 777111
#define BARRIER_INIT_STEP2 888111
#define BARRIER_INIT_STEP3 999111
#define BARRIER_FINALIZE   555111
#define MMAP_NAME_PREFIX "TknIPM"
...
void setInterProcessMemcpyFunctionPointers(TakyonPrivatePath *private_path) {

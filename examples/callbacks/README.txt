...
----
  Mac and Linux:
    ...
    Multi process:
      ...
      Terminal 1: > ./callbacks "Socket -client -IP=127.0.0.1 -port=12345" -endpointA
      Terminal 2: > ./callbacks "Socket -server -IP=127.0.0.1 -port=12345 -reuse"

      Terminal 1: > ./callbacks "Socket -client -IP=127.0.0.1 -ID=1" -endpointA -poll
      Terminal 2: > ./callbacks "Socket -server -IP=Any -ID=1" -poll
